...
//************************************
// Description: Phần Header cho trang dành cho Giám đốc.
//************************************
...
function DirectorHeader() {
  ...
  // Sau khi đăng nhập, lấy dữ liệu liên quan của giám đốc và lưu trữ vào emPloyerDetails.
  useEffect(() => {
    if (token) {
      dispatch(fetchUser());
            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
              <div className="relative flex h-16 items-center justify-between">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  ...
                  Khi nhấn vào hình ảnh người dùng, sẽ hiện tên của Giám đốc và nút Đăng xuất */}
